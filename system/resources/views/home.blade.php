...
<body>
              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="detail-box">
                    ...
                    <p>
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quaerat mollitia, reprehenderit odio soluta obcaecati pariatur magni aut ad impedit, consequatur, quidem adipisci, odit officiis! Vitae nemo dolore commodi quos corrupti iste ut quas ab aliquam, asperiores consequuntur quasi illo repellat similique possimus, officia, libero, repellendus minus sequi numquam doloremque perferendis?
                    </p>
                    <div class="btn-box">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6 col-lg-3">
          <div class="box ">
            <div class="img-box">
              <img src="{{url('assets')}}/images/feature-1.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Fast Delivery
        ...
        <div class="col-md-6 col-lg-3">
          <div class="box ">
            <div class="img-box">
              <img src="{{url('assets')}}/images/feature-2.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Free Shiping
        ...
        <div class="col-md-6 col-lg-3">
          <div class="box ">
            <div class="img-box">
              <img src="{{url('assets')}}/images/feature-3.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Best Quality
        ...
        <div class="col-md-6 col-lg-3">
          <div class="box ">
            <div class="img-box">
              <img src="{{url('assets')}}/images/feature-4.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
        ...
        <div class="col-md-6">
          <div class="img_container">
            <div class="img-box b1">
              <img src="{{url('assets')}}/images/a-1.jpg" alt="">
            </div>
            <div class="img-box b2">
              <img src="{{url('assets')}}/images/a-2.jpg" alt="">
            </div>
          </div>
        </div>
        <div class="col-md-6">
    ...
    <div class="container">
      ...
      <div class="product_container">
        <div class="box">
          <div class="box-content">
            <div class="img-box">
              <img src="{{url('assets')}}/images/w7.png" alt="">
            </div>
            <div class="detail-box">
              <div class="text">
                <h6>
        ...
        <div class="box">
          <div class="box-content">
            <div class="img-box">
              <img src="{{url('assets')}}/images/w8.png" alt="">
            </div>
            <div class="detail-box">
              <div class="text">
                <h6>
        ...
        <div class="box">
          <div class="box-content">
            <div class="img-box">
              <img src="{{url('assets')}}/images/w9.png" alt="">
            </div>
            <div class="detail-box">
              <div class="text">
                <h6>
  ...
  <!-- jQery -->
  <script type="text/javascript" src="{{url('system')}}/resources/js/jquery-3.4.1.min.js"></script>
  <!-- popper js -->
  <script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.0/dist/umd/popper.min.js" integrity="sha384-Q6E9RHvbIyZFJoft+2mJbHaEWldlvI9IOYy5n3zV9zzTtmI3UksdQRVvoxMfooAo" crossorigin="anonymous">
  </script>
  <!-- bootstrap js -->
  <script type="text/javascript" src="{{url('system')}}/resources/js/bootstrap.js"></script>
  <!-- custom js -->
  <script type="text/javascript" src="{{url('system')}}/resources/js/custom.js"></script>
  <!-- Google Map -->
